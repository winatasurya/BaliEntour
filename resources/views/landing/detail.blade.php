...
<div class="mt-8">
  ...
  <div class="mt-4 flex space-x-4 overflow-x-auto scrollable-container">
    <div class="p-4 border rounded-lg shadow flex-none w-96">
      ...
      <p class="text-gray-600 mt-2">Seru sekali bisa kasih makan hewan secara langsung. Wahana juga banyak.</p>
    ...
    <div class="p-4 border rounded-lg shadow flex-none w-96">
      ...
      <p class="text-gray-600 mt-2">Mantul pesan dan digunakan di hari yang sama aman banget jadi ga perlu takut ya sobat tiket</p>
...
<div class="mt-8">
  ...
  <div class="mt-4 relative">
    <div class="overflow-hidden rounded-lg shadow" style="max-width: 100%; max-height: 300px;">
      <iframe id="mapEmbed" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.274252759748!2d115.1384535!3d-8.665447!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd2477f04748e85%3A0x65b83481caecd509!2sAtlas%20Beach%20Club!5e0!3m2!1sid!2sid!4v1720359560772!5m2!1sid!2sid"
              width="100%" height="100%" style="border: 0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
      </iframe>
    </div>
    <div class="mt-2 flex items-center">
      <span class="text-gray-600">Jalan Kapten Harun Kabir, Cibeureum, Bogor Regency, West Java, Indonesia, Cisarua, Bogor, Jawa Barat, Indonesia</span>
    </div>
  ...
  <div class="mt-8 p-4 border rounded-lg shadow">
    <h3 class="text-lg font-semibold">Taman Safari Indonesia Bogor - tiket.com Exclusive</h3>
    <p class="mt-2 text-gray-600">Mulai dari <span class="text-red-500 font-bold">IDR 150.000</span></p>
    <button class="mt-4 w-full bg-blue-500 text-white px-4 py-2 rounded-lg">Lihat Paket</button>
  </div>
</div>
        ...
        <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          ...
          <form class="mt-4">
            ...
            <div class="mb-4">
              ...
              <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="review" placeholder="Tulis review Anda di sini..." rows="4"></textarea>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
              <label class="block text-gray-700 text-sm font-bold mb-2" for="relationship">Hubungan</label>
              <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="relationship">
            ...
            <div class="flex items-center justify-between">
              ...
              <button id="closeModalButton" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                Batal
              </button>
            </div>
          </form>
