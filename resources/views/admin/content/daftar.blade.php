...
<body>
    ...
    <div class="main-content">
        ...
        <div class="search-container">
            ...
            <form action="{{ route('admin.perusahaan.search') }}" method="GET">
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>
                                <button class="btn btn-blue" onclick="showDetails({{ $user->id }})" data-bs-toggle="modal" data-bs-target="#detailModal">Detail</button>
...
<script>
  function showDetails(userId) {
    // Fetch company details using AJAX (adjust URL as needed)
    fetch(`/admin/perusahaan/${userId}`)
