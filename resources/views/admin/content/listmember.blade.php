                    ...
                    <div id="crud-modal" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative p-4 w-full max-w-4xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <!-- Modal body -->
                                <form class="p-4 md:p-5" action="{{ route('createuser') }}" method="POST"
                                    ...
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="col-span-2 sm:col-span-1">
                                            ...
                                            <input type="text" name="alamat_user" id="alamat_user"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <tr
                        ...
                        @foreach ($datalis as $data)
                            ...
                            <th scope="row"
                                ...
                                <img class="w-10 h-10 rounded-full" src="{{ asset('storage/img/' . $data->image) }}"
                                    alt="Jese image">
                                <div class="ps-3">
                            ...
                            <td class="px-6 py-4">
                                <!-- Modal toggle -->
                                <button data-modal-target="editUserModal{{ $data->iduser }}"
                                    data-modal-toggle="editUserModal{{ $data->iduser }}"
                                    class="text-blue-600 hover:text-blue-900">Edit</button>
                                <!-- Main modal -->
                                <div id="editUserModal{{ $data->iduser }}" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="flex items-start justify-between mb-4">
                                                ...
                                                <button type="button"
                                                    ...
                                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                                                            d="M10 12.586l4.95 4.95a1 1 0 001.414-1.414l-4.95-4.95 4.95-4.95a1 1 0 10-1.414-1.414L10 10.172l-4.95-4.95a1 1 0 10-1.414 1.414l4.95 4.95-4.95 4.95a1 1 0 001.414 1.414l4.95-4.95z"
                                                            clip-rule="evenodd"></path>
                                                    </svg>
                                                </button>
                                            </div>
                                            <form action="{{ route('updateuser', $data->iduser) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="mb-4">
                                                ...
                                                <div class="mb-4">
                                                    <label for="telp_user"
                                                        class="block text-sm font-medium">Telepon</label>
                                                    <input type="text" name="telp_user" id="telp_user"
                                                ...
                                                <button type="submit"
                                                    class="block w-full px-4 py-2 text-white bg-blue-600 rounded-md">Simpan</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                <!-- Tombol untuk membuka modal -->
                                <button data-modal-target="popup-modal{{ $data->iduser }}"
                                    data-modal-toggle="popup-modal{{ $data->iduser }}"
                                    class="font-medium text-red-600 dark:text-red-500 hover:underline" type="button">
                                    Remove
                                </button>

                                <!-- Modal -->
                                <div id="popup-modal{{ $data->iduser }}" tabindex="-1"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <button type="button"
                                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                data-modal-hide="popup-modal{{ $data->iduser }}">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <form action="{{ route('destroyuser', $data->iduser) }}" method="POST"
                                                    class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                                ...
                                                <button data-modal-hide="popup-modal{{ $data->iduser }}" type="button"
