            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Perusahaan</span>
                ...
                <li>
                    <a href="{{ route('daftarwisatawan') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Wisatawan</span>
                    </a>
                </li>
                <!-- <li>
                    <a href="listproduk"
